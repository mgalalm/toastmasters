            ...
            <div>
                <div class="mt-6 border-t border-gray-100 dark:border-white/10">
                    <dl class="divide-y divide-gray-100 dark:divide-white/10">
                        ...
                        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt class="text-sm/6 font-medium text-gray-900 dark:text-gray-100">Workshop</dt>
                            <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-400">
                                <template v-if="speech.workshop_id">
                                    <Link
                                        :href="route('workshops.show', { id: speech.workshop_id })"
                                        class="font-medium text-gray-900 dark:text-white"
                                    >
                                        {{ speech.workshop_title }}
                                    </Link>
                                </template>
                                <template v-else>
                                    <span class="text-gray-500 dark:text-gray-400">—</span>
...
console.log('Speech props:', props.speech);
